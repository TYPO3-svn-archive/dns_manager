...
class tx_dnsmanager_cm1 {
	function main(&$backRef,$menuItems,$table,$uid)	{
		...
		if (!$backRef->cmLevel)	{
			...
			$url = t3lib_extMgm::extRelPath("dns_manager")."cm1/index.php?id=".$uid;
			$localItems[] = $backRef->linkItem(
				$GLOBALS["LANG"]->getLLL("cm1_title",$LL),
				$backRef->excludeIcon('<img src="'.t3lib_extMgm::extRelPath("dns_manager").'cm1/cm_icon.gif" width="15" height="12" border=0 align=top>'),
	 ...
	 */
	function includeLL()	{
		include(t3lib_extMgm::extPath("dns_manager")."locallang.php");
		return $LOCAL_LANG;
	}
} 
...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/dns_manager/class.tx_dnsmanager_cm1.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/dns_manager/class.tx_dnsmanager_cm1.php"]);
}
